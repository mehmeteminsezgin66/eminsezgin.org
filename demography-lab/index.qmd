...
**Yöntem:** Basitleştirilmiş kuşak-bileşenleri (Leslie matrisi). Baz yıl kadın nüfusu TÜİK ADNKS 2025, yaşa özel doğurganlık hızları (YÖDH) TÜİK 2025 değerleridir. Ölümlülük, Türkiye kadın yaşam tablosu (e₀ ≈ 81) ile uyumlu yaş-spesifik hayatta kalma oranlarına dayanır. Göç modele dahil edilmemiştir (kapalı nüfus varsayımı).
...
// Ages 0-16: TÜİK kız doğum verisi (2009-2025), mortalite düzeltmeli
// Ages 17+: TÜİK ADNKS 2025 toplam kadın nüfusuna (43.032.734) kalibre edilmiş tahmin
femPop2025 = {
  // Ages 0-16: TÜİK kız doğum verisi (2009-2025), mortalite düzeltmeli
  // Ages 17-49: TÜİK 2025 doğum sayısına (895.000) kalibre edilmiş (×1,069)
  // Ages 50+: TÜİK toplam kadın = 43.032.734'e kalibre (×0,902)
  const p = [
    433268, 455713, 467950, 505325, 527203,   // 0-4
    545078, 580344, 611257, 632075, 640009,   // 5-9
    650458, 656502, 629916, 629603, 608658,   // 10-14
    612696, 614703, 612335, 612335, 612335,   // 15-19
    612335, 612335, 612335, 612335, 612335,   // 20-24
    630183, 630183, 630183, 630183, 630183,   // 25-29
    630183, 630183, 630183, 630183, 630183,   // 30-34
    656402, 656402, 656402, 656402, 656402,   // 35-39
    656402, 656402, 656402, 656402, 656402,   // 40-44
    605572, 605572, 605572, 605572, 605572,   // 45-49
    448678, 448678, 448678, 448678, 448678,   // 50-54
    448678, 448678, 448678, 448678, 448678,   // 55-59
    373585, 373585, 373585, 373585, 373585,   // 60-64
    373585, 373585, 373585, 373585, 373585,   // 65-69
    294517, 294517, 294517, 294517, 294517,   // 70-74
    294517, 294517, 294517, 294517, 294517,   // 75-79
    108770, 108770, 108770, 108770, 108770,   // 80-84
    108770, 108770, 108770, 108770, 108770,   // 85-89
    16733, 16733, 16733, 16733, 16733,        // 90-94
    16733, 16733, 16733, 16733, 16733,        // 95-99
    16733                                      // 100
  ];
  return p;
}
