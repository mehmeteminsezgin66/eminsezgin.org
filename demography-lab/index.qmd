...
bar_veri = [
  {yil: yil_a, siralama: "1. Cocuk", deger: deger_a.cocuk1, fark: 0},
  {yil: yil_a, siralama: "2. Cocuk", deger: deger_a.cocuk2, fark: 0},
  {yil: yil_a, siralama: "3. Cocuk", deger: deger_a.cocuk3, fark: 0},
  {yil: yil_a, siralama: "4+ Cocuk", deger: deger_a.cocuk4, fark: 0},
  {yil: yil_b, siralama: "1. Cocuk", deger: deger_b.cocuk1, fark: fark_1},
  {yil: yil_b, siralama: "2. Cocuk", deger: deger_b.cocuk2, fark: fark_2},
  {yil: yil_b, siralama: "3. Cocuk", deger: deger_b.cocuk3, fark: fark_3},
  {yil: yil_b, siralama: "4+ Cocuk", deger: deger_b.cocuk4, fark: fark_4}
]
...
Plot.plot({
  ...
  marks: [
    ...
    Plot.text(bar_veri, {x: "yil", y: "deger", text: d => d.deger.toFixed(2),
      ...
      // Yigin icindeki orta noktaya yerlesim icin manuel y-offset gerekmedigi durumda Plot otomatik konumlandirir
    }),
    Plot.text(bar_veri.filter(d => d.yil === yil_b), {x: "yil", y: "deger",
...
::: {.callout-important appearance="simple"}
**Nasil okunur:** Sol sutun ${yil_a}, sag sutun ${yil_b} yilina ait TDH'nin doğum sırasına göre bilesenlerini gosterir (her renk bir dogum sirasi). Sag sutunun yaninda, ${yil_a}'dan ${yil_b}'ye o bilesendeki degisim (kirmizi=azalma, yesil=artma) etiketlenmistir.

**Kaynak:** TUIK Dogum Istatistikleri, dogum sirasina gore TDH bilesenleri (TDHₙ = TDH × (n. sira payi/100)), 2013-2025 tam seri (resmi TDH serisine tam toplanacak sekilde olceklenmistir). Varsayilan secimde (2013→2025), toplam TDH kaybinin (-0,68) en buyuk tek kaynagi **2. cocuktur** (1→2 gecisi) — diger uc bilesenin her biri ayri ayri daha az katki yapar. Farkli yil ciftleri secerek (orn. 2021 vs 2025) son donemdeki hizlanmayi da gozlemleyebilirsiniz.
:::
